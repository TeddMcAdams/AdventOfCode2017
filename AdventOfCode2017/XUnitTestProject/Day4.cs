...
namespace XUnitTestProject
{
    public class Day4
    {
        private readonly string _input = @"una bokpr ftz ryw nau yknf fguaczl anu
...
lpyubo dylpfb iehwug decj ntidy cuygyg lalkb iutu oxgm imn";
        ...
        {
            //Part1
            Assert.Equal(477, Part1(_input));

            //Part2
            Assert.Equal(167, Part2(_input));
        }

        private int Part1(string input)
        {
            List<string> allPassphrases = ParseInputString();

            return allPassphrases
                .Where(EveryWordIsUnique)
                .Count();
        }
        ...
        private int Part2(string input)
        {
            ...
            return allPassphrases
                .Where(m => EveryWordIsUnique(m) && HasNoAnagrams(m))
                .Count();
        }

        private List<string> ParseInputString()
        {
            return _input
        ...
        private bool EveryWordIsUnique(string passphrase)
        {
            List<string> words = passphrase
        ...
        private bool HasNoAnagrams(string passphrase)
        {
            bool result = true;
        ...
        private bool AreAnagrams(string word1, string word2)
        {
            if (string.IsNullOrEmpty(word1) || string.IsNullOrEmpty(word2))
                throw new ArgumentException("Nah dude.");
            ...
            return string.IsNullOrEmpty(word2);
        }
    }
}
